                  ...
                  >
                    <div className="flex items-center space-x-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-white font-medium text-sm truncate">{raid.name}</p>
                    ...
                    {inRaid ? (
                      <Link
                        to={`/raids/${raid.id}`}
                        className="flex items-center space-x-1 bg-green-600 hover:bg-green-700 text-white text-xs font-medium px-2 py-1 rounded transition-colors flex-shrink-0"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 text-white text-xs font-medium px-2 py-1 rounded transition-colors flex-shrink-0"
                      >
