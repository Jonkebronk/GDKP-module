export const ERROR_CODES = {
  ...
  // Pre-auction errors
  PRE_AUCTION_NOT_ACTIVE: 'PRE_AUCTION_NOT_ACTIVE',
  PRE_AUCTION_ENDED: 'PRE_AUCTION_ENDED',
  PRE_AUCTION_ALREADY_LOCKED: 'PRE_AUCTION_ALREADY_LOCKED',
  PRE_AUCTION_ITEM_NOT_FOUND: 'PRE_AUCTION_ITEM_NOT_FOUND',
